                ...
                <li key={idx}>
                  {link.title === "Catalog" ? (
                    <div className="relative flex items-center gap-2 group">
                      ...
                      <div
                        className="invisible absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[80%] *:flax flex-col rounded-md bg-richblack-5 text-richblue-900 opacity-0 transition-all 
