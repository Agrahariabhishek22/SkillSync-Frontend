...
function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 sm:px-6 md:px-8 bg-universal ">
      <form
        onSubmit={handleOnSubmit}
        className="w-full max-w-md flex flex-col gap-y-6 p-6 sm:p-8 md:p-10 bg-richblack-800 rounded-xl shadow-lg"
      >
        ...
        <label className="flex flex-col gap-1">
          ...
          <input
            ...
            className="rounded-md bg-richblack-900 p-3 text-richblack-5 placeholder:text-richblack-400 focus:outline-none"
        ...
        <label className="relative flex flex-col gap-1">
          ...
          <input
            ...
            className="rounded-md bg-richblack-900 p-3 pr-12 text-richblack-5 placeholder:text-richblack-400 focus:outline-none"
            style={{ boxShadow: "inset 0 -1px 0 rgba(255, 255, 255, 0.18)" }}
          />
          <span
